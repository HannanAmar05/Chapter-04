...
export const PopularMovie = () => {
  ...
  return (
    ...
    <div className='flex items-center justify-center text-white text-2xl py-2'><h1>POPULAR MOVIE</h1></div>
    <div className='grid grid-cols-5'>
    {Data.map((movie)=> [
      
        <div className='my-6' key={movie.id}>
            <img className='w-11/12 rounded-t-md' src={`https://image.tmdb.org/t/p/original/${movie.poster_path}`} alt="" />
